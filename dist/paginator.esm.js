...
class Paginator extends EventEmitter {
    ...
    forceRender() {
        ...
        if (this.config.options.pluginContainer) {
            B$2(this.createPluginElement(), this.config.options.pluginContainer);
        }
        return this;
    }
    destroy() {
        ...
        if (this.config.options.pluginContainer) {
            B$2(null, this.config.options.pluginContainer);
        }
    }
    render(container) {
        if (!container) {
